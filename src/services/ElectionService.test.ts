...
describe('ElectionService', () => {
    ...
    describe('Candidate Management', () => {
        ...
        it('should throw error when adding candidate to non-existent election', () => {
            expect(() => service.addCandidate('non-existent', { name: 'Test', party: 'Test', biography: 'Test' })).toThrow('Election not found');
        });
        ...
        it('should throw error when adding candidate to active election', () => {
            ...
            expect(() => service.addCandidate(election.electionID, { name: 'Late', party: 'Late', biography: 'Late' })).toThrow('Cannot add candidates to non-draft elections');
        });
    });
    ...
    describe('Election Lifecycle', () => {
        ...
        it('should throw error when activating election with insufficient candidates', () => {
            ...
            expect(() => service.activateElection(emptyElection.electionID)).toThrow('Election must have at least 2 candidates');
        });
